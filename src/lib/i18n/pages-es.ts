...
export const pagesEs = {
	...
	volunteer: {
		...
		phoneHint: 'Usamos este número para contactarle rápidamente por mensaje de texto.',
		zip: 'Código postal',
		zipOptional: 'opcional',
		zipHint: 'Cinco dígitos, o cinco dígitos, guion y cuatro más (campo opcional).',
		helpLegend: '¿Cómo le gustaría ayudar?',
		helpCanvassing: 'Casa a casa (canvassing)',
		helpPhoneBanking: 'Llamadas telefónicas',
		helpTextBanking: 'Mensajes de texto',
		helpHosting: 'Organizar un evento',
		helpDataEntry: 'Datos / administración',
		helpWherever: 'Donde haga falta',
